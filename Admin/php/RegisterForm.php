...
if(isset($_POST['submit'])){
	...
	$select = "	SELECT * FROM admin_details	WHERE email = '$Email_Address'";
	...
	if(mysqli_num_rows($result)>0){
		...
		if($Password != $CPassword){
			...
			$insert = "INSERT INTO admin(first_name, last_name, email_address, user_name, password) 
			...
			<div class="container">
				<div class="form">
					...
					<form action="" method="post">
						...
						<p>Already An Admin ? <a href="loginForm.php">Login now</a></p>
					</form>
				</div>
			</div>
		</div>
